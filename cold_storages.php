...
<div id="myBtnContainer">
  ...
  <button class="btn" onclick="filterSelection('nearby_coldstorages')"> Nearby Cold-Storages</button>
...
<?php
                ...
                $center_lat = filter_input(INPUT_POST, 'Email');
                $center_lng = filter_input(INPUT_POST, 'Email');
                $query = sprintf("SELECT *, ( 6371 * acos( cos( radians('%s') ) * cos( radians( lat ) ) * cos( radians( lan ) - radians('%s') ) + sin( radians('%s') ) * sin( radians( lat ) ) ) ) AS distance 
                                 FROM coldstorages ORDER BY distance LIMIT 0 , 20",$center_lat,$center_lng,$center_lat);
  ...
  <div class="column nearby_coldstorages">
    <div class="content">
...
<br>
        ...
        <i class="fa fa-map-marker"><?php echo $product['address']; ?></i>
...
<?php
                ...
                $query = sprintf("SELECT *, ( 6371 * acos( cos( radians('%s') ) * cos( radians( lat ) ) * cos( radians( lan ) - radians('%s') ) + sin( radians('%s') ) * sin( radians( lat ) ) ) ) AS distance 
                                 FROM coldstorages ORDER BY max_facilities desc LIMIT 0 , 20",$center_lat,$center_lng,$center_lat);
